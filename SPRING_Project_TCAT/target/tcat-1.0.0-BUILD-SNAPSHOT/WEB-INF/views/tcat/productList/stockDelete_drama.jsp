						...
						<table
							...
							<c:if test="${cnt > 0}">
								...
								<c:if test="${startPage > pageBlock}">
									<a href="stockDelete_drama">[◀◀]</a>
									<a href="stockDelete_drama?pageNum=${startPage - pageBlock}">[◀]</a>
								</c:if>
								...
								<c:forEach var="i" begin="${startPage}" end="${endPage}">
									...
									<c:if test="${i != currentPage}">
										<a href="stockDelete_drama?pageNum=${i}">[${i}]</a>
									</c:if>
								</c:forEach>
								...
								<c:if test="${pageCount > endPage}">
									<a href="stockDelete_drama?pageNum=${startPage + pageBlock}">[▶]</a>
									<a href="stockDelete_drama?pageNum=${pageCount}">[▶▶]</a>
								</c:if>
							</c:if>
						</table>
					</div>
