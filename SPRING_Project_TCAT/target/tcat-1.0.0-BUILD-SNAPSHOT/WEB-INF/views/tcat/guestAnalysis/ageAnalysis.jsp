...
<div class="row">
	...
	<c:forEach var="ageGenre" items="${ageGenreList}">
		<c:set var="tf"
			value="${ageGenre.get('뮤지컬') + ageGenre.get('무용') +ageGenre.get('콘서트')+ageGenre.get('클래식')+ageGenre.get('연극')}" />
		<c:if test="${tf !=0  }">
			<div class="col-md-12" style="border-bottom: 1px solid lightgrey">
				<!-- 연령별 장르 선호도  -->
				<div class="col-md-6">
					<h3>${index}0대이상 장르 선호도</h3>
					<br>
