		...
		<div class="row pt5">
			...
			<div class="col-md-2 thumbnail">
				<div class="list-group pt11">
				  ...
				  <a href="#" class="list-group-item">1. 김건모</a>
				  <a href="#" class="list-group-item">2. 트와이스</a>
				  <a href="#" class="list-group-item">3. 아이유</a>
				  <a href="#" class="list-group-item">4. DJDOC</a>
				  <a href="#" class="list-group-item">5. 싸이</a>
				</div>
			</div>	
