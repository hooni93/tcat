...
<div class="row">
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
				  ...
				  <div class="carousel-inner" role="listbox">
				    <div class="item active">
				      <img src="${image}concert/A_1.jpg"  width="100%" height="300px" alt="A_1">
				      <div class="carousel-caption">
				
				      </div>
				    </div>
				    <div class="item">
				      <img src="${image}concert/A_2.jpg" width="100%" height="300px" alt="A_2">
				      <div class="carousel-caption">
				
				      </div>
				    </div>
				    <div class="item">
				      <img src="${image}concert/A_3.jpg" width="100%" height="300px" alt="A_3">
				      <div class="carousel-caption">
 ...
 <div class="row">
	...
	<div class="col-md-12 h25 bff3333 pt3"><span class="ffffff trgothic" onclick="load('photoBoarder?category=32');">콘서트 사진 게시판</span></div>		
	<c:if test="${photoCnt!=0}">
<div class="container-fluid">
    <div id="custom_carousel" class="carousel slide" data-ride="carousel" data-interval="4000">
        <!-- Wrapper for slides -->
            <a onclick="load('photoBoarder?category=32');">
	...
	<div class="col-md-6 thumbnail">
		<div class="col-md-12 h25 b333366 pt3"><span class="ffffff trgothic hand" onclick="load('movieBoarder?category=22');">콘서트 영상 게시판</span></div>		
    ...
    <div id="movie_carousel" class="carousel slide" data-ride="carousel" data-interval="4000">
        <!-- Wrapper for slides -->
       <a onclick="load('movieBoarder?category=22');">
        <div class="carousel-inner">
           <%
