	   ...
	   <div class="row">
                 ...
                 <table class="c" style="width: 1000px" align="center">
						...
						<c:if test="${startPage > pageBlock}">
							...
							<a onclick="load('join_retireMember?pageNum=${startPage - pageBlock}');">[◀]</a>
						</c:if>
						...
						<c:forEach var="i" begin="${startPage}" end="${endPage}">
							...
							<c:if test="${i != currentPage}">
								<a onclick="load('join_retireMember?pageNum=${i}');">[${i}]</a>
							</c:if>
						</c:forEach>
						...
						<c:if test="${pageCount > endPage}">
							<a onclick="load('join_retireMember?pageNum=${startPage + pageBlock}');">[▶]</a>
							<a onclick="load('join_retireMember?pageNum=${pageCount}');">[▶▶]</a>
						</c:if>
					</c:if></th>
					</tr>
				</table>
		...
		<br>
				 ...
				 <div class="col-md-5">
				 	   ...
				 	   <input type="hidden" name="reUrl" value="join_retireMember">
				 	   <input type="hidden" name="search" value="1">
                            ...
                            <div class="form-group">
                              ...
                              <button type="button" class="btn btn-default" onclick="ajaxSubmit('join_retireMember')">검색</button>
                         </form>
				 </div> 
				</div>
