...
<div class="row">
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
				  ...
				  <div class="carousel-inner" role="listbox">
				    <div class="item active">
				      <img src="${image}dance/A_1.jpg"  width="100%" height="500px" alt="A_1">
				      <div class="carousel-caption">
				
				      </div>
				    </div>
				    <div class="item">
				      <img src="${image}dance/A_2.jpg" width="100%" height="500px" alt="A_2">
				      <div class="carousel-caption">
				
				      </div>
				    </div>
				    <div class="item">
				      <img src="${image}dance/A_3.jpg" width="100%" height="500px" alt="A_3">
				      <div class="carousel-caption">
 ...
 <div class="row">
	...
	<div class="col-md-12 h25 bff3333 pt3"><span class="ffffff trgothic" onclick="load('photoBoarder?category=35');">무용 사진 게시판</span></div>		
...
<div class="container-fluid">
	...
	<div class="col-md-6 thumbnail">
		<div class="col-md-12 h25 b333366 pt3"><span class="ffffff trgothic hand" onclick="load('movieBoarder?category=25');">무용 영상 게시판</span></div>		
