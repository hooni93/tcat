		...
		<div class="row pt5 h100p">
			...
			<div class="col-md-2 thumbnail h300">
				<div class="list-group pt11">
				  ...
				  <a href="#" class="list-group-item">2. 춤을 말하다</a>
				  <a href="#" class="list-group-item">3. 국립발레단공연</a>
				  <a href="#" class="list-group-item">4. 돈키호테</a>
				  <a href="#" class="list-group-item">5. 안나카레니나</a>
				</div>
			</div>	
