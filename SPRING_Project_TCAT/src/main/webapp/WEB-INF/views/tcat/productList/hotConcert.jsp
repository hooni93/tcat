							...
							<tr>
								<th align="center"><c:if test="${cnt > 0}">
										...
										<c:if test="${startPage > pageBlock}">
											...
											<a
												onclick="categoryload0('hotConcert','${category}','${startPage - pageBlock}');">[◀]</a>
										</c:if>
										...
										<c:forEach var="i" begin="${startPage}" end="${endPage}">
											...
											<c:if test="${i != currentPage}">
												<a
													onclick="categoryload0('hotConcert','${category}','${i}');">[${i}]</a>
											</c:if>
										</c:forEach>
										...
										<c:if test="${pageCount > endPage}">
											<a
												onclick="categoryload0('hotConcert','${category}','${startPage + pageBlock}');">[▶]</a>
											<a
												onclick="categoryload0('hotConcert','${category}','${pageCount}');">[▶▶]</a>
										</c:if>
									</c:if></th>
							</tr>
						</table>
