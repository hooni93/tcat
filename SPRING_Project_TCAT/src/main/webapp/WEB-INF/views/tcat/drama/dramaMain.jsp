...
<div class="row">
	...
	<div class="col-md-12 h25 bff3333 pt3"><span class="ffffff trgothic" onclick="load('photoBoarder?category=33');">연극 사진 게시판</span></div>		
...
<div class="container-fluid">
	...
	<div class="col-md-6 thumbnail">
		<div class="col-md-12 h25 b333366 pt3"><span class="ffffff trgothic hand" onclick="load('movieBoarder?category=23');">연극 영상 게시판</span></div>		
