...
<div class="row">
 ...
 <div class="row">
	...
	<div class="col-md-12 h25 bff3333 pt3"><span class="ffffff trgothic" onclick="load('photoBoarder?category=34');">클래식 사진 게시판</span></div>		
...
<div class="container-fluid">
	...
	<div class="col-md-6 thumbnail">
		<div class="col-md-12 h25 b333366 pt3"><span class="ffffff trgothic hand" onclick="load('movieBoarder?category=24');">클래식 영상 게시판</span></div>		
