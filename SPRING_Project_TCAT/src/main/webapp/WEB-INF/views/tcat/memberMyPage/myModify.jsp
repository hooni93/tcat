      ...
      <div class="col-md-10">
         <div class="row">
            ...
            <tr>
               <th>* 비밀번호</th>
               <td>
                  <input class="input" type="password" name="pwd" maxlength="10" value="${vo.member_pwd()}">
               </td>
            </tr>
            <tr>
               <th>* 비밀번호 확인</th>
            ...
            <tr>
               <th>* 이름</th>
               <td>
                  <input class="input" type="text" name="name" maxlength="20" value="${vo.member_name()}">
               </td>
            </tr>
            <tr>
               <th>전화번호</th>
            ...
            <tr>
               <th colspan="2">
                  <input type="button" value="수정" onclick ="myModify()">
