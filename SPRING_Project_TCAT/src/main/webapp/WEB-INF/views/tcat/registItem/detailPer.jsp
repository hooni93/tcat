...
<div class="container">
	<div class="row">
		<b>공연 상세 수정 페이지</b><input data-toggle="modal" data-target="#myModal" type="button"style="margin-left:20px;" class="myButton" value="image">
		<input data-toggle="modal" data-target="#myMovie" type="button"style="margin-left:20px;" class="myButton" value="movie">
	</div>
    <hr>
    <form action="updateDetailPer" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
		...
		<input type="text" name="move_url" placeholder="동영상 url 추가">
		<input type="submit"class="myButton" style="margin-left:10px" value="수정">
	</div>
   </form>
</div>
<!-- Modal -->
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" style="width:700px;">
    <div class="modal-content">
    	<img src="${image}/performance/${dto.detail_image}">
    </div>
  </div>
</div>

<div class="modal fade" id="myMovie" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" style="width:700px;">
    <div class="modal-content">
