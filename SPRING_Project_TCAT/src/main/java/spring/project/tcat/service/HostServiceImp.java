	...
	//상품목록 나열
		...
		public void categoryList(HttpServletRequest req, Model model) {
			...
			if (cnt > 0) {
				...
				map.put("start", start);
				map.put("end", end);
				map.put("Hcnt", Hcnt); // category에서 보낸 cnt값
				// 표 목록 조회
	...
	/////////////////////////////////// 태성 1/10 end /////////////////////////////////////////
		...
		public void performanceInsert(MultipartHttpServletRequest req, Model model) {
			...
			try {
				...
				//시작날짜와 종료날짜에 -를 붙인다
				String ssDate=sDate[0]+"-"+sDate[1]+"-"+sDate[2];
				String eeDate=eDate[0]+"-"+eDate[1]+"-"+eDate[2];
		...
		public void insertStore(MultipartHttpServletRequest req, Model model) {
			...
			String realDir = "E:\\Team_project\\projectGit\\tcat\\SPRING_Project_TCAT\\src\\main\\webapp\\resources\\image\\images\\";
			String saveDir = req.getRealPath("/resources/image/images/");
			try {
